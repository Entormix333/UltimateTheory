...
var init = () => {
    ...
    // c1
    {
        ...
        c1 = theory.createUpgrade(0, currency, new FirstFreeCost(new ExponentialCost(3, Math.log2(2))));
    ...
    // c2
    {
        ...
        c2 = theory.createUpgrade(1, currency, new ExponentialCost(1e10000, Math.log2(1e100)));
    ...
    theory.createBuyAllUpgrade(1, currency, 1e75);
    ...
    {
        c1Exp = theory.createMilestoneUpgrade(0, 20);
    ...
    {
        c2Exp = theory.createMilestoneUpgrade(1, 45);
        c2Exp.description = Localization.getUpgradeIncCustomExpDesc("c_2", "2");
        c2Exp.info = Localization.getUpgradeIncCustomExpInfo("c_2", "2");
...
var getPublicationMultiplier = (tau) => tau.pow(2.112) / BigNumber.THREE;
